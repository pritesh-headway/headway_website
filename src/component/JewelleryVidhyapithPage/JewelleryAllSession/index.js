...
const JewelleryAllSession = ({isVisible,titleRef}) => {
    ...
    return (
        <>
            <section ref={titleRef}>
                <div className="flex justify-center items-center px-16 py-12 w-full text-5xl font-medium max-md:px-5 max-md:max-w-full max-md:text-4xl max-sm:py-0">
                    <div className=" flex flex-col my-6 max-w-full w-[1296px] max-md:text-4xl">
                        ...
                        <div className="flex gap-5 justify-between max-w-full w-[1296px] max-md:flex-wrap max-md:mb-10 ">
                            <div
                            ...
                            >
                                <span className=" leading-[58px]">Suvarna Saubhagya Utsav  </span>
                                <span className="font-bold text-orange-500 leading-[58px]">
                                (SSU)
                                </span>
                            </div>
            ...
            <div className='  ' style={{ transform: 'none !important' }}>
                ...
                >
                    ...
                    {companyImg.map((item, index) => (
                        ...
                        <div 
                        className="px-5 "
                        // className="px-5 all_non_transition section collapsible"
                        ...
                        >
                            <img src={item} alt="Images"
                                loading="lazy"
                                // className='sub-section-border-box '
                            //  className="jewellery_all_session"
                ...
                {/* <div class="section">
                    <div class="sub-section-border-box label">label</div>
                    <div class="sub-section-border-box field">field</div>
                </div>
                ...
                <button id="show" type="button">Show/Hide</button> */}
            </div>
        </>
    )
}

export default UpdatedAnimatedComponent(JewelleryAllSession)