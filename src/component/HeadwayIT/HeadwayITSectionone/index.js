...
const HeadwayITSectionone = () => {
    return (
        <>
            <div className="flex flex-col items-start relative max-h-[50%] ">
                <div className=" flex gap-5 justify-between ml-2.5 max-w-full max-md:flex-wrap headwayitSectionone">
                    <img
                        loading="lazy"
...
export default HeadwayITSectionone