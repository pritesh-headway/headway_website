...
const ResBrochureSection = ({ titleRef, isVisible }) => {
    return (
        <>
            ...
            ref={titleRef}>
                <div className="flex overflow-hidden relative flex-col justify-center items-center px-16 py-12 w-full fill-stone-50 max-md:px-5 max-md:max-w-full">
                    <img
                        ...
                        alt=''
                    />
                    <div className=" my-6 max-w-full w-[1296px] z-10 rounded-2xl">
                        <div className=" flex justify-between gap-5 max-md:gap-0 max-md: shadow-orange-50 shadow-lg bg-white ps-10  max-sm:px-3 ">
...
export default UpdatedAnimatedComponent(ResBrochureSection)