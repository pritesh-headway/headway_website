...
const AllSectionone = ({ src, title, link_to2, link_name2, link_to3, link_name3, link_to4, link_name4,bg_title }) => {
    return (
        <>
            ...
            >
                <div className=" flex gap-5 justify-between max-w-full max-md:flex-wrap ">
                    <img
                        ...
                        width={100} 
                        height={100}
                        className='w-full max-sm:aspect-[5.6] self-start'
                        // className='w-full max-sm:aspect-[3.6] self-start'
                    />
                </div>
                <div className='absolute text-gray-100 font-bold text-9xl bottom-0 left-[20%] '>
                    {bg_title}
                </div>
                <div className='absolute w-full h-full px-16 max-md:px-5 z-10'>
                    <div className="max-w-full w-[1296px]  mx-auto flex items-center h-full ">
                        <div
                            ...
                            className="text-start animation_fadeInRight1 top-[50%]  mt-1 font-semibold text-orange-500 text-[60px] max-md:max-w-full xl:text-6xl lg:text-5xl md:text-4xl max-md:text-lg sm:left-[20%] max-sm:pl-5"
                        >
                            {title}
