                ...
                <nav className="animation_fadeInRight2 flex mt-5 max-md:mt-1" aria-label="Breadcrumb">
                    <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse  ">
                        <li className="inline-flex items-center ">
                            <Link to={'/'} className="max-sm:text-xs inline-flex items-center text-base font-medium text-gray-700 hover:text-orange-600 ">
                                Home
                            </Link>
                        </li>
                        <li>
                            <div className="flex items-center">
                                ...
                                <Link
                                    href={'/our_services'}
                                    className="ms-1 max-sm:text-xs text-base font-medium  text-gray-700 hover:text-orange-600 md:ms-2 "
                                >
                                    Our Services
                                </Link>
                            </div>
                        ...
                        <li>
                            <div className="flex items-center">
                                ...
                                <Link
                                    href={'/start_up'}
                                    className="ms-1 max-sm:text-xs text-base font-medium text-orange-500 hover:text-orange-600 md:ms-2 "
                                >
                                    Start Up
                                </Link>
                            </div>
